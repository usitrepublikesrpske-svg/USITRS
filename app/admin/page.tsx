        ...
        {activeTab === "news" && (
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">URL слике</label>
                <input
                  type="text"
                  value={newsForm.image}
                  onChange={(e) => setNewsForm({ ...newsForm, image: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  placeholder="/slika.jpg или https://..."
                />
              </div>
              <div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Галерија слика (до 6)</label>
                <input
                  type="text"
                  value={newsForm.gallery}
                  onChange={(e) => setNewsForm({ ...newsForm, gallery: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  placeholder="URL слика раздвојене зарезом"
                />
              </div>
              <button
